...
public final class M {
	...
	private void set_h(java.util.List<java.lang.Long> list_1) {
		...
		this.M_size += h_TagEncodeSize;// add tag length
		int length_1 = 0;
		for (java.lang.Long value_1 : list_1) {
			length_1 += Serializer.computeVarInt64Size(value_1);
			this.h.add(value_1);
		}
		this.M_size += Serializer.computeVarInt32Size(length_1);// add length byte size
		this.M_size += length_1;
	...
	private static void decode_h(ByteBuf buf, M a_1) {
	...
	private void set_i(java.util.List<java.lang.Integer> list_1) {
		...
		this.M_size += i_TagEncodeSize;// add tag length
		int length_1 = 0;
	...
	private static void decode_i(ByteBuf buf, M a_1) {
	...
	private void set_j(java.util.List<java.lang.Long> list_1) {
		...
		this.M_size += j_TagEncodeSize;// add tag length
		int length_1 = 0;
		for (java.lang.Long value_1 : list_1) {
			length_1 += 8;
			this.j.add(value_1);
	...
	private static void decode_j(ByteBuf buf, M a_1) {
	...
	private void set_k(java.util.List<java.lang.String> list_1) {
		...
		this.M_size += k_TagEncodeSize * list_1.size();// add tag length
	...
	private static void decode_k(ByteBuf buf, M a_1) {
	...
	private void set_l(java.util.List<byte[]> list_1) {
		...
		this.M_size += l_TagEncodeSize * list_1.size();// add tag length
	...
	private static void decode_l(ByteBuf buf, M a_1) {
		byte[] value_1 = null;
	...
	public static M decode(ByteBuf buf) {
		M value_1 = new M();
		...
		value_1.M_size = buf.readerIndex() - f_Index;
		return value_1;
	}
	...
	public static M decode(ByteBuf buf, int length_1) {
		M value_1 = new M();
		int f_Index = buf.readerIndex();
	...
	public static MBuild newBuilder() {
		return new MBuild();
	}
	...
	public static class MBuild {
		...
		public MBuild add_h_value(java.lang.Long a) {
			if (a == null) {
		...
		public MBuild remove_h_value(int index) {
			if (this.h == null || index >= this.h.size()) {
				throw new RuntimeException("h is null or index bigger than h size");
			}
		...
		public MBuild add_i_value(java.lang.Integer a) {
			if (a == null) {
				throw new RuntimeException("a is null");
			}
			if (this.i == null) {
		...
		public MBuild remove_i_value(int index) {
			if (this.i == null || index >= this.i.size()) {
				throw new RuntimeException("i is null or index bigger than i size");
			}
		...
		public MBuild add_j_value(java.lang.Long a) {
			if (a == null) {
				throw new RuntimeException("a is null");
			}
			if (this.j == null) {
		...
		public MBuild remove_j_value(int index) {
			if (this.j == null || index >= this.j.size()) {
				throw new RuntimeException("j is null or index bigger than j size");
			}
		...
		public MBuild add_k_value(java.lang.String a) {
			if (a == null) {
				throw new RuntimeException("a is null");
			}
			if (this.k == null) {
		...
		public MBuild remove_k_value(int index) {
			if (this.k == null || index >= this.k.size()) {
				throw new RuntimeException("k is null or index bigger than k size");
			}
		...
		public MBuild add_l_value(byte[] a) {
			if (a == null) {
				throw new RuntimeException("a is null");
			}
			if (this.l == null) {
		...
		public MBuild remove_l_value(int index) {
			if (this.l == null || index >= this.l.size()) {
				throw new RuntimeException("l is null or index bigger than l size");
			}

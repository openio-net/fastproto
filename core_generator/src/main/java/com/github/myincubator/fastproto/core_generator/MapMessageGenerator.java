...
public class MapMessageGenerator {
    ...
    public static void Gen(Filed filed, PrintWriter pw, Map<String, Meta> metaMap, Object map, String className){
        ...
        pw.println();
        pw.println();
        set(pw,key,value,filed,className,metaMap);
        pw.println();

        get(pw,fileName,metaMap,key,value);

        pw.println();

        getKeySet(pw,fileName,metaMap,key);
        pw.println();
        has(pw,fileName);
        pw.println();
        encode(pw,key,value,fileName,metaMap);
        pw.println();
        decode(pw,fileName,metaMap,key,value,className);
        pw.println();
        put(pw,fileName,metaMap,key,value);
        pw.println();
    ...
    private static void set(PrintWriter pw,Filed key,Filed value,Filed filed,String className,Map<String, Meta> metaMap){
        String keyType= Util.getJavaType(key,metaMap);
        String valueType= Util.getJavaType(value,metaMap);
        String fileName=filed.getFiledName();
    ...
    private static void put(PrintWriter pw, String fileName,  Map<String, Meta> metaMap, Filed key,Filed value){
    ...
    private static void decode(PrintWriter pw, String fileName,  Map<String, Meta> metaMap, Filed key,Filed value,String className){
    ...
    private static void encode(PrintWriter pw,Filed key,Filed value,String fileName,Map<String,Meta> metaMap){

...
public class RepeatedMessageGenerator {
    ...
    private static void set(PrintWriter pw,Filed filed,String ClassName,Map<String,Meta> metaMap,boolean packed){
   ...
   private static void packedSet(PrintWriter pw,Filed filed,String ClassName,Map<String,Meta> metaMap){
    ...
    private static void set(PrintWriter pw,Filed filed,String ClassName,Map<String,Meta> metaMap){
        String fileName=filed.getFiledName();
    ...
    private static void add(PrintWriter pw,   Map<String, Meta> metaMap,Filed value){
        String fileName=value.getFiledName();
    ...
    private static void decode(PrintWriter pw,  Map<String, Meta> metaMap,Filed value,String className,boolean packed){
        String fileName=value.getFiledName();
    ...
    private static void packedDecode(PrintWriter pw,   Map<String, Meta> metaMap,Filed value){
        String fileName=value.getFiledName();
    ...
    private static void decode(PrintWriter pw,   Map<String, Meta> metaMap, Filed value){
        String fileName=value.getFiledName();
        pw.format("         %s value_1=null;\n", Util.getJavaType(value,metaMap));
    ...
    private static void encode(PrintWriter pw,Filed value,Map<String,Meta> metaMap,boolean packed){
        String fileName=value.getFiledName();
    ...
    private static void packedEncode(PrintWriter pw,Filed value,Map<String,Meta> metaMap){
        String fileName=value.getFiledName();
    ...
    private static void encode(PrintWriter pw,Filed value,Map<String,Meta> metaMap){
        String fileName=value.getFiledName();
        pw.format("         for(%s value_1: %s){\n", Util.getJavaType(value,metaMap),fileName);
        pw.format("         Serializer.encodeVarInt32(buf,%s_Tag);\n", value.getFiledName());
        Util.encodeFiled(pw,value,"buf","value_1");
